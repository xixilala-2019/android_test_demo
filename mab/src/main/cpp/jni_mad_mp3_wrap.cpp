...
Java_com.demo.mab_NativeMP3Decoder_initAudioPlayer(JNIEnv *env, jobject obj, jstring file,jint startAddr)
{
...
extern "C" JNIEXPORT jint JNICALL
Java_com.demo.mab_NativeMP3Decoder_getAudioBuf(JNIEnv *env, jobject obj ,jshortArray audioBuf,jint len)
{
	int bufsize = 0;
	int ret = 0;
    if(audioBuf != NULL)
...
extern "C" JNIEXPORT jint JNICALL
Java_com.demo.mab_NativeMP3Decoder_getAudioSamplerate(JNIEnv *env,jobject obj)
{
}
...
Java_com.demo.mab_NativeMP3Decoder_rePlayAudioFile(JNIEnv *env,jobject obj)
{
	rePlayAudioFile();
}

extern "C" JNIEXPORT void JNICALL
Java_com.demo.mab_NativeMP3Decoder_closeAudioFile(JNIEnv *env,jobject obj)
{
