...
public class CkSsh {
  ...
  public int get_ClientPort() {
    return chilkatJNI.CkSsh_get_ClientPort(swigCPtr, this);
  }

  public void put_ClientPort(int newVal) {
    chilkatJNI.CkSsh_put_ClientPort(swigCPtr, this, newVal);
  }
  ...
  public void get_ServerIdentifier(CkString str) {
    chilkatJNI.CkSsh_get_ServerIdentifier(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String serverIdentifier() {
    return chilkatJNI.CkSsh_serverIdentifier(swigCPtr, this);
  }
  ...
  public boolean get_StripColorCodes() {
    return chilkatJNI.CkSsh_get_StripColorCodes(swigCPtr, this);
  }

  public void put_StripColorCodes(boolean newVal) {
    chilkatJNI.CkSsh_put_StripColorCodes(swigCPtr, this, newVal);
  }
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkSsh_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkSsh_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkSsh_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean AuthenticateSecPw(CkSecureString login, CkSecureString password) {
    return chilkatJNI.CkSsh_AuthenticateSecPw(swigCPtr, this, CkSecureString.getCPtr(login), login, CkSecureString.getCPtr(password), password);
  }

  public CkTask AuthenticateSecPwAsync(CkSecureString login, CkSecureString password) {
    long cPtr = chilkatJNI.CkSsh_AuthenticateSecPwAsync(swigCPtr, this, CkSecureString.getCPtr(login), login, CkSecureString.getCPtr(password), password);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean AuthenticateSecPwPk(CkSecureString username, CkSecureString password, CkSshKey privateKey) {
    return chilkatJNI.CkSsh_AuthenticateSecPwPk(swigCPtr, this, CkSecureString.getCPtr(username), username, CkSecureString.getCPtr(password), password, CkSshKey.getCPtr(privateKey), privateKey);
  }

  public CkTask AuthenticateSecPwPkAsync(CkSecureString username, CkSecureString password, CkSshKey privateKey) {
    long cPtr = chilkatJNI.CkSsh_AuthenticateSecPwPkAsync(swigCPtr, this, CkSecureString.getCPtr(username), username, CkSecureString.getCPtr(password), password, CkSshKey.getCPtr(privateKey), privateKey);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ChannelSendData(int channelNum, CkByteData byteData) {
    return chilkatJNI.CkSsh_ChannelSendData(swigCPtr, this, channelNum, CkByteData.getCPtr(byteData), byteData);
  }

  public CkTask ChannelSendDataAsync(int channelNum, CkByteData byteData) {
    long cPtr = chilkatJNI.CkSsh_ChannelSendDataAsync(swigCPtr, this, channelNum, CkByteData.getCPtr(byteData), byteData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean ChannelSendString(int channelNum, String textData, String charset) {
    return chilkatJNI.CkSsh_ChannelSendString(swigCPtr, this, channelNum, textData, charset);
  }

  public CkTask ChannelSendStringAsync(int channelNum, String textData, String charset) {
    long cPtr = chilkatJNI.CkSsh_ChannelSendStringAsync(swigCPtr, this, channelNum, textData, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean Connect(String domainName, int port) {
    return chilkatJNI.CkSsh_Connect(swigCPtr, this, domainName, port);
  }

  public CkTask ConnectAsync(String domainName, int port) {
    long cPtr = chilkatJNI.CkSsh_ConnectAsync(swigCPtr, this, domainName, port);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean GetReceivedDataN(int channelNum, int maxNumBytes, CkByteData outBytes) {
    return chilkatJNI.CkSsh_GetReceivedDataN(swigCPtr, this, channelNum, maxNumBytes, CkByteData.getCPtr(outBytes), outBytes);
  }
  ...
  public int OpenDirectTcpIpChannel(String targetHostname, int targetPort) {
    return chilkatJNI.CkSsh_OpenDirectTcpIpChannel(swigCPtr, this, targetHostname, targetPort);
  }

  public CkTask OpenDirectTcpIpChannelAsync(String targetHostname, int targetPort) {
    long cPtr = chilkatJNI.CkSsh_OpenDirectTcpIpChannelAsync(swigCPtr, this, targetHostname, targetPort);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public int QuickCmdCheck(int pollTimeoutMs) {
    return chilkatJNI.CkSsh_QuickCmdCheck(swigCPtr, this, pollTimeoutMs);
  }

  public CkTask QuickCmdCheckAsync(int pollTimeoutMs) {
    long cPtr = chilkatJNI.CkSsh_QuickCmdCheckAsync(swigCPtr, this, pollTimeoutMs);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public int QuickCmdSend(String command) {
    return chilkatJNI.CkSsh_QuickCmdSend(swigCPtr, this, command);
  }

  public CkTask QuickCmdSendAsync(String command) {
    long cPtr = chilkatJNI.CkSsh_QuickCmdSendAsync(swigCPtr, this, command);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean QuickCommand(String command, String charset, CkString outStr) {
    return chilkatJNI.CkSsh_QuickCommand(swigCPtr, this, command, charset, CkString.getCPtr(outStr), outStr);
  }

  public String quickCommand(String command, String charset) {
    return chilkatJNI.CkSsh_quickCommand(swigCPtr, this, command, charset);
  }

  public CkTask QuickCommandAsync(String command, String charset) {
    long cPtr = chilkatJNI.CkSsh_QuickCommandAsync(swigCPtr, this, command, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public int QuickShell() {
    return chilkatJNI.CkSsh_QuickShell(swigCPtr, this);
  }

  public CkTask QuickShellAsync() {
    long cPtr = chilkatJNI.CkSsh_QuickShellAsync(swigCPtr, this);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean SendReqExec(int channelNum, String commandLine) {
    return chilkatJNI.CkSsh_SendReqExec(swigCPtr, this, channelNum, commandLine);
  }

  public CkTask SendReqExecAsync(int channelNum, String commandLine) {
    long cPtr = chilkatJNI.CkSsh_SendReqExecAsync(swigCPtr, this, channelNum, commandLine);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean SendReqPty(int channelNum, String termType, int widthInChars, int heightInChars, int widthInPixels, int heightInPixels) {
    return chilkatJNI.CkSsh_SendReqPty(swigCPtr, this, channelNum, termType, widthInChars, heightInChars, widthInPixels, heightInPixels);
  }

  public CkTask SendReqPtyAsync(int channelNum, String termType, int widthInChars, int heightInChars, int widthInPixels, int heightInPixels) {
    long cPtr = chilkatJNI.CkSsh_SendReqPtyAsync(swigCPtr, this, channelNum, termType, widthInChars, heightInChars, widthInPixels, heightInPixels);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean SetTtyMode(String ttyName, int ttyValue) {
    return chilkatJNI.CkSsh_SetTtyMode(swigCPtr, this, ttyName, ttyValue);
  }
