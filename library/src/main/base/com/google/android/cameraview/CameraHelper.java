...
public class CameraHelper {
    ...
    private static final String KEY_ONLY_USE_CAMERA1 = "key_only_use_camera1";
    ...
    public void setOnlyUseCamera1() {
        if (mSharedPreferences != null) {
            mSharedPreferences.edit().putBoolean(KEY_ONLY_USE_CAMERA1, true).apply();
        }
    }

    public boolean getOnlyUseCamera1() {
        if (mSharedPreferences != null) {
            return mSharedPreferences.getBoolean(KEY_ONLY_USE_CAMERA1, false);
        }
        return false;
    }
